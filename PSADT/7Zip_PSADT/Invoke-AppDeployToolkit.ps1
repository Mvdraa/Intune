...
$adtSession = @{
    ...
    AppScriptDate = '2025-05-08'
    AppScriptAuthor = '7zip'
...
function Install-ADTDeployment
{
    ...
    ## Show Welcome Message, close 7zip if required, allow up to 3 deferrals, verify there is enough disk space to complete the install, and persist the prompt.
    Show-ADTInstallationWelcome -CloseProcesses '7z.exe' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
    ...
    Start-ADTProcess -FilePath "7z2409-x64.exe" -ArgumentList '/S'
    ...
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message '7zip installed succesfully, credits to Beunhaas B.V.' -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath "C:\Program Files\7-Zip\uninstall.exe" -ArgumentList '/S'
